...
export const metadata = {
  ...
  description: "Karnataka's trusted institute for typewriting, shorthand, stenography, computer education, 100% result-focused training, and career-ready commerce skills since 1975.",
  openGraph: {
